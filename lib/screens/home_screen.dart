...
class HomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      // 1. O STREAMBUILDER AGORA ENVOLVE O ECRÃ TODO!
      child: StreamBuilder<List<UserPlant>>(
        ...
        builder: (context, snapshot) {
          ...
          // 2. CALCULAMOS AS PLANTAS URGENTES AQUI EM CIMA
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    // --- SINO COM BOLINHA VERMELHA (Já sabe ler as urgentPlants) ---
                    Container(
  ...
  Widget _buildPlantCard(BuildContext context, UserPlant plant) {
    return InkWell(
      borderRadius: BorderRadius.circular(16),
      onTap: () {
        // Envia os dados em formato de Map (como o main.dart espera)
